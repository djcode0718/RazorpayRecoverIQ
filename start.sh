...
if [[ -x "/Users/sj/miniforge3/envs/razor-env/bin/python" ]]; then
  PYTHON_BIN="/Users/sj/miniforge3/envs/razor-env/bin/python"
...
(cd "$ROOT_DIR/frontend" && npm run dev -- --host "$HOST" --port "$FRONTEND_PORT") &
FRONTEND_PID=$!
